...
for hiddenlayers in [100, 250, 50, 75]:
    for parallellayer in [0]:
        for learningRate in [.0001, .001, .01]:
            ...
            if ((hiddenlayers!=10) or (parallellayer!=0)):
                ...
                logfile = './logs/final_hl' + str(hl) + '_lr' + str(learningRate) + '_pl' +str(parallellayer)
