...
def model(vocabulary, hidden_size,num_steps,use_dropout,learningrate,activation):
...
model=model(vocabulary, hidden_size,num_steps,use_dropout,learningrate,activation)
